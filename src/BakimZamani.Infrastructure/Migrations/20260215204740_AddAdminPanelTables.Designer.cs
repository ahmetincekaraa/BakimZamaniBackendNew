...
namespace BakimZamani.Infrastructure.Migrations
{
    ...
    [Migration("20260215204740_AddAdminPanelTables")]
    partial class AddAdminPanelTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BakimZamani.Domain.Entities.AdminLog", b =>
                {
            ...
            modelBuilder.Entity("BakimZamani.Domain.Entities.Campaign", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BakimZamani.Domain.Entities.PackageService", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(26)
                        .HasColumnType("character varying(26)");
            ...
            modelBuilder.Entity("BakimZamani.Domain.Entities.Salon", b =>
                {
                    ...
                    b.Property<int>("MaxCustomersPerHour")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BakimZamani.Domain.Entities.ServicePackage", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(26)
                        .HasColumnType("character varying(26)");
            ...
            modelBuilder.Entity("BakimZamani.Domain.Entities.AdminLog", b =>
                {
                    b.HasOne("BakimZamani.Domain.Entities.User", "Admin")
                        .WithMany()
            ...
            modelBuilder.Entity("BakimZamani.Domain.Entities.PackageService", b =>
                {
                    b.HasOne("BakimZamani.Domain.Entities.ServicePackage", "Package")
            ...
            modelBuilder.Entity("BakimZamani.Domain.Entities.Salon", b =>
                {
                    b.HasOne("BakimZamani.Domain.Entities.User", "ApprovedByAdmin")
                        .WithMany()
                    ...
                    b.HasOne("BakimZamani.Domain.Entities.User", "SuspendedByAdmin")
                        .WithMany()

...
public class VectorSearchService : IVectorSearchService
{
    ...
    {
        // Hair services
        ["saç"] = GenerateSimpleVector(1),
        ["kesim"] = GenerateSimpleVector(2),
        ["boya"] = GenerateSimpleVector(3),
        ["röfle"] = GenerateSimpleVector(4),
        ["fön"] = GenerateSimpleVector(5),
        ["perma"] = GenerateSimpleVector(6),
        ["keratin"] = GenerateSimpleVector(7),
        ["bakım"] = GenerateSimpleVector(8),
        
        // Nail services
        ["tırnak"] = GenerateSimpleVector(10),
        ["manikür"] = GenerateSimpleVector(11),
        ["pedikür"] = GenerateSimpleVector(12),
        ["protez"] = GenerateSimpleVector(13),
        ["jel"] = GenerateSimpleVector(14),
        ["kalıcı"] = GenerateSimpleVector(15),
        ["oje"] = GenerateSimpleVector(16),
        
        // Face services
        ["cilt"] = GenerateSimpleVector(20),
        ["yüz"] = GenerateSimpleVector(21),
    ...
    public async Task<ApiResponse<List<SalonListResponse>>> SearchSalonsByServiceAsync(string query, string? city = null, int limit = 20)
    {
        ...
        {
            return ApiResponse<List<SalonListResponse>>.Fail("Arama sorgusu boş olamaz.");
        }
